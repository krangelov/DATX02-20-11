...
public class TranslatorKeyboard extends Keyboard {
    ...
    public static final int KEYCODE_PAGE_CHANGE     = -10;
    public static final int KEYCODE_SOURCE_LANGUAGE = -100;
    public static final int KEYCODE_TARGET_LANGUAGE = -200;
    public static final int MAX_LANGUAGE_KEYCODES = 99;
